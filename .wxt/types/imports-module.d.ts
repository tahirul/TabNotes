...
declare module '#imports' {
  ...
  export { DashboardApp } from '../components/DashboardApp';
  export { NoteCard, NoteCardProps } from '../components/NoteCard';
  export { SidePanelApp } from '../components/SidePanelApp';
}
